...
$ git clone https://github.com/3salles/delivery-socket.git

# Entre na pasta `delivery-socket`:
...
Na pasta delivery-socket, instale as dependências pelo seguinte comando:
